			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					if (isset($_POST['asset_asign_btn'])) {
						...
						//$query=mysqli_query($conn,"SELECT * FROM `asigned_assets` WHERE `serial_no`='$serial' AND `status`='$status_use'");
						...
						$my_sql=mysqli_query($conn,"UPDATE `it_assets` SET asign_status='$asign' WHERE `id`='$asset_id'");

						if ($sql_query AND $my_sql) {
							$alart="info";
							$type= "Successful!!";
							$msg= "Asset Asigned Successfuly. and Record Updated Successfuly";
													...
													<div class="col-md-8">
														...
														<form action="" method="POST">
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<textarea name="notes" rows="5" class="form-control" placeholder="Describe about This Assets"></textarea>
																</div>
															</div>
