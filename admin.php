						...
						<div class="col-md-12">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs">
									...
									<li class="active">	
									<a href="#tab3" data-toggle="tab"><i class="fa  fa-rocket"></i>  Add Assets</a>
									</li>
									<li>	
							...
							<header class="panel-heading">
								...
								<div class="row">
									...
									<div class="form-group col-sm-9">
										<a href="#newbill" class="mb-xs mt-xs mr-xs btn btn-danger modal-with-form"> <i class="fa fa-book"></i> Meeter Reading</a>
										<a class="mb-xs mt-xs mr-xs btn btn-success" href="#RentPaid" data-toggle="tab"><i class="fa  fa-rupee"></i>  <?php echo $balance;?>  <i class="fa  fa-rocket"></i>  Pay Rent</a>	
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-danger">Success</button>
													...
													<tbody>
														...
														while ($row=mysqli_fetch_array($query)) {
											               ...
											               echo "<td>".$row['purchase_date']."</td>";
											                ...
											                echo "<td>
							               							<div class='actions'>
							               							<a href=asign.php?id=".$row['id']." class='fa  fa-send' data-original-title='Asign This Asset to any user' data-toggle='tooltip' data-placement='top' title=''></a>
							               							<a href=#?id=".$row['id']." class='fa fa-pencil'>  </a>
										...
										<div class="row">
											<div class="col-md-8">
												<section class="panel">
													...
													<div class="form-group">
														<label class="col-md-3 control-label">Assets<span class="required">*</span></label>
														<div class="col-md-4">
														...
														<div class="col-md-4">
															<select data-plugin-selectTwo class="form-control populate" id="brand"  >
										                        ...
										                        <option value="Lanevo">Lanevo</option>
													...
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputTooltip">Modal No<span class="required">*</span></label>
														<div class="col-md-4">
														...
														<label class="col-md-1 control-label" for="inputTooltip">Purchase</label>
														<div class="col-md-4">
													...
													<div class="form-group">
														<label class="col-md-3 control-label" for="inputTooltip">Serial No<span class="required">*</span></label>
														<div class="col-md-9">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea name="skills" rows="5" class="form-control" placeholder="Describe your skills" id="remark" required></textarea>
														</div>
													</div>
